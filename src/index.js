...
import patientRoutes from './route/user.route.js';
...
app.get('/', (req, res) => res.send(new Response(HttpStatus.OK.code, HttpStatus.OK.status, 'User API, v1.0.0 - All Systems Go')));
